...
class Blog extends \yii\db\ActiveRecord
{
    ...
    public function upload()
    {
        if ($this->validate()) {
            ...
            Image::resize("uploads/blog/img_{$this->id}.{$this->image->extension}", 750, 370)
	            ->save("uploads/blog/img_{$this->id}.{$this->image->extension}");
            Image::thumbnail("uploads/blog/img_{$this->id}.{$this->image->extension}", 80, 80)
                ->save("uploads/blog/thumb_{$this->id}.{$this->image->extension}");
